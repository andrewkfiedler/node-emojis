...
describe('html', () => {
  it('should replace an emoji on the beginning of the line', () =>
    assert.strictEqual(
      emojis.html(':beer: is the answer'),
  ...
  it('should replace even with colons on text', () =>
    assert.strictEqual(
      emojis.html('Here\'s some math for you: :beer: + :beer: = :beers:'),
      'Here\'s some math for you: <img class="emoji" width="20" height="20" src="beer.png" alt="beer"> + <img class="emoji" width="20" height="20" src="beer.png" alt="beer"> = <img class="emoji" width="20" height="20" src="beers.png" alt="beers">'
    )
  )
})
...
describe('unicode', () => {
  ...
  it('should replace even with colons on text', () =>
    assert.strictEqual(
      emojis.unicode('Here\'s some math for you: :beer: + :beer: = :beers:'),
